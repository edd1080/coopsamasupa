...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start overflow-x-auto max-w-full pb-2 hide-scrollbar rounded-md p-1 text-muted-foreground w-full",
      className
    )}
    style={{
